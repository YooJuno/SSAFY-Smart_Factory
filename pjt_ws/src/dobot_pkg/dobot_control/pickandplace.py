...
class PickAndPlace(Node):
    def __init__(self):
        ...
        test_x, test_y, test_z = add_offset(240.0, 0.0, -60.0)

        self.tasks_list = [
            ["move", [test_x, test_y, -59.0, 0.0], 1],
            # ["move", [180.0+tcp_offset_x, 60.0, 30.0+tcp_offset_z, 0.0], 1]
            # ["gripper", True],
            # ["move", [176.0, 63.0, 0.0, 0.0], 1],
            # ["move", [176.0, 63.0, 0.0, 0.0], 1],
            # ["gripper",False],
            # ["move", [176.0, 63.0, 0.0, 0.0], 1],
            # ["move", [10.0, 220.0, 0.0, 0.0], 1]   
        ]
